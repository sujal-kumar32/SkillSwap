...
const LearnerProfile = () => {
  ...
  if (loading) {
    return (
      <>
        <PageHeader title="Learner Profile" subtitle="Manage your account, skills, interests, goals, and social links." />
        ...
        <div className="col-xl-8">
          ...
          <div className="learner-card p-4 mb-4">
            ...
            <div className="row g-3">
              ...
              <div className="col-md-6">
                <input name="github" className="form-control rounded-pill" placeholder="GitHub / Portfolio URL" value={profile.github} onChange={handleChange} />
              </div>
            </div>
          </div>
